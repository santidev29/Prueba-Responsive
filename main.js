...
const containerMatrix = document.querySelector('.containerMatrix')
let timeoutId;
...
function contentPosition(){
  tooltips.forEach(tooltip => {
    ...
    } else if (pin.offsetLeft + containerMatrix.offsetLeft < content.offsetWidth / 2 ){
      // console.log('left conflict', pin.offsetLeft)
      content.style.left = - containerMatrix.offsetLeft +'px';
      content.style.top = pin.offsetTop + 30 + 'px';
    } else {
